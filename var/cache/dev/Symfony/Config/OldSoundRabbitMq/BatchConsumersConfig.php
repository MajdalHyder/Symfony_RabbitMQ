...
require_once __DIR__.\DIRECTORY_SEPARATOR.'BatchConsumersConfig'.\DIRECTORY_SEPARATOR.'ExchangeOptionsConfig.php';
require_once __DIR__.\DIRECTORY_SEPARATOR.'BatchConsumersConfig'.\DIRECTORY_SEPARATOR.'QueueOptionsConfig.php';
require_once __DIR__.\DIRECTORY_SEPARATOR.'BatchConsumersConfig'.\DIRECTORY_SEPARATOR.'GracefulMaxExecutionConfig.php';
require_once __DIR__.\DIRECTORY_SEPARATOR.'BatchConsumersConfig'.\DIRECTORY_SEPARATOR.'QosOptionsConfig.php';
...
class BatchConsumersConfig 
{
    ...
    public function exchangeOptions(array $value = []): \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\ExchangeOptionsConfig
    {
        if (null === $this->exchangeOptions) {
            $this->exchangeOptions = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\ExchangeOptionsConfig($value);
        } elseif ([] !== $value) {
    ...
    public function queueOptions(array $value = []): \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\QueueOptionsConfig
    {
        if (null === $this->queueOptions) {
            $this->queueOptions = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\QueueOptionsConfig($value);
        } elseif ([] !== $value) {
    ...
    public function gracefulMaxExecution(array $value = []): \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\GracefulMaxExecutionConfig
    {
        if (null === $this->gracefulMaxExecution) {
            $this->gracefulMaxExecution = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\GracefulMaxExecutionConfig($value);
        } elseif ([] !== $value) {
    ...
    public function qosOptions(array $value = []): \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\QosOptionsConfig
    {
        if (null === $this->qosOptions) {
            $this->qosOptions = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\QosOptionsConfig($value);
        } elseif ([] !== $value) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (isset($value['exchange_options'])) {
            $this->exchangeOptions = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\ExchangeOptionsConfig($value['exchange_options']);
            unset($value['exchange_options']);
        }
    
        if (isset($value['queue_options'])) {
            $this->queueOptions = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\QueueOptionsConfig($value['queue_options']);
        ...
        if (isset($value['keep_alive'])) {
            $this->keepAlive = $value['keep_alive'];
            unset($value['keep_alive']);
        }
    
        if (isset($value['graceful_max_execution'])) {
            $this->gracefulMaxExecution = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\GracefulMaxExecutionConfig($value['graceful_max_execution']);
        ...
        if (isset($value['qos_options'])) {
            $this->qosOptions = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\QosOptionsConfig($value['qos_options']);
    ...
    public function toArray(): array
    {
        ...
        if (null !== $this->keepAlive) {
            $output['keep_alive'] = $this->keepAlive;
        }
        if (null !== $this->gracefulMaxExecution) {
