...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'old_sound_rabbit_mq.order_create_audi_mercedes_consumer' => 'getOldSoundRabbitMq_OrderCreateAudiMercedesConsumerService',
            'old_sound_rabbit_mq.order_create_bmw_consumer' => 'getOldSoundRabbitMq_OrderCreateBmwConsumerService',
            'old_sound_rabbit_mq.order_create_producer' => 'getOldSoundRabbitMq_OrderCreateProducerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('event.order_create', [0 => function () {
            return ($this->privates['event_listener.order'] ?? $this->load('getEventListener_OrderService'));
        }, 1 => 'onOrderCreate'], 0);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fv2rQrbiQM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
        ...
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'OldSoundRabbitMqBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'php-amqplib'.\DIRECTORY_SEPARATOR.'rabbitmq-bundle'),
            ...
            'old_sound_rabbit_mq.base_amqp' => [
                0 => 'old_sound_rabbit_mq.order_create_producer',
                1 => 'old_sound_rabbit_mq.order_create_bmw_consumer',
                2 => 'old_sound_rabbit_mq.order_create_audi_mercedes_consumer',
            ],
            'console.command.ids' => [
