 ...
 */
class getOrderLogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrderLogRepository' shared autowired service.
     *
     * @return \App\Repository\OrderLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrderLogRepository.php';

        return $container->privates['App\\Repository\\OrderLogRepository'] = new \App\Repository\OrderLogRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
