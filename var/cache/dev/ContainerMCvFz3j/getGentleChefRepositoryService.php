 ...
 */
class getGentleChefRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GentleChefRepository' shared autowired service.
     *
     * @return \App\Repository\GentleChefRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GentleChefRepository.php';

        return $container->privates['App\\Repository\\GentleChefRepository'] = new \App\Repository\GentleChefRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
