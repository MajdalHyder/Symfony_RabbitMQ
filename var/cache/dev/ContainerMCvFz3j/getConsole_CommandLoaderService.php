...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'old_sound_rabbit_mq.anon_consumer_command' => ['privates', 'old_sound_rabbit_mq.anon_consumer_command', 'getOldSoundRabbitMq_AnonConsumerCommandService', true],
            'old_sound_rabbit_mq.batch_consumer_command' => ['privates', 'old_sound_rabbit_mq.batch_consumer_command', 'getOldSoundRabbitMq_BatchConsumerCommandService', true],
            'old_sound_rabbit_mq.consumer_command' => ['privates', 'old_sound_rabbit_mq.consumer_command', 'getOldSoundRabbitMq_ConsumerCommandService', true],
            'old_sound_rabbit_mq.delete_command' => ['privates', 'old_sound_rabbit_mq.delete_command', 'getOldSoundRabbitMq_DeleteCommandService', true],
            'old_sound_rabbit_mq.dynamic_consumer_command' => ['privates', 'old_sound_rabbit_mq.dynamic_consumer_command', 'getOldSoundRabbitMq_DynamicConsumerCommandService', true],
            'old_sound_rabbit_mq.multiple_consumer_command' => ['privates', 'old_sound_rabbit_mq.multiple_consumer_command', 'getOldSoundRabbitMq_MultipleConsumerCommandService', true],
            'old_sound_rabbit_mq.purge_consumer_command' => ['privates', 'old_sound_rabbit_mq.purge_consumer_command', 'getOldSoundRabbitMq_PurgeConsumerCommandService', true],
            'old_sound_rabbit_mq.command.rpc_server_command' => ['privates', 'old_sound_rabbit_mq.command.rpc_server_command', 'getOldSoundRabbitMq_Command_RpcServerCommandService', true],
            'old_sound_rabbit_mq.command.setup_fabric_command' => ['privates', 'old_sound_rabbit_mq.command.setup_fabric_command', 'getOldSoundRabbitMq_Command_SetupFabricCommandService', true],
            'old_sound_rabbit_mq.command.std_in_producer_command' => ['privates', 'old_sound_rabbit_mq.command.std_in_producer_command', 'getOldSoundRabbitMq_Command_StdInProducerCommandService', true],
